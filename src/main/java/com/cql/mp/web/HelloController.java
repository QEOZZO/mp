package com.cql.mp.web;

import com.cql.mp.entity.Orders;
import com.cql.mp.entity.User;
import com.cql.mp.vo.UserChildVo;
import com.cql.mp.vo.UserVo;
...
public class HelloController {
    ...
    public User say2(Orders orders){
        System.out.print("hello");
        return new User();
    }
    /**
    ...
    public List<String> say3(@RequestBody UserVo userVo ){
        System.out.print("hello");
    ...
    public UserChildVo say4(@RequestBody List<Orders> orders ){
        System.out.print("hello");
        return new UserChildVo();
    }
